  ...
  return (
    <>
      ...
      <div className="flex justify-center flex-col  mb-[120px]  md:mx-[120px] ">
        ...
        <div className="flex justify-center flex-col border-[15px] bg-white border-[#734F96]   p-10 ">
          <div className="flex items-center gap-2">
            <RiCustomerService2Fill className="text-[#734F96] text-[1.5rem] font-bold " />
            <h1 className="text-[#734F96] text-[1.5rem] font-bold ">
              Customer Care
            </h1>
          </div>
          <br />
          ...
          <div className="flex flex-col justify-center">
            <p className="text-lg  text-[#734F96] font-thin tracking-widest">
            ...
            <br />
            <div className="flex items-center gap-2">
              <AiOutlineSafety className="text-[#734F96] text-[1.5rem] font-bold " />
              <h1 className="text-[#734F96] text-[1.5rem] font-bold ">
                Privacy & Safety
              </h1>{" "}
              <br /> <br />
            ...
            <div className="flex items-center gap-2">
              <BiPurchaseTag className="text-[#734F96] text-[1.5rem] font-bold " />
              <h1 className="text-[#734F96] text-[1.5rem] font-bold ">
                Wholesale Inquiries
              </h1>{" "}
              <br /> <br />
            ...
            <div className="flex items-center gap-2">
              <MdOutlinePayment className="text-[#734F96] text-[1.5rem] font-bold " />
              <h1 className="text-[#734F96] text-[1.5rem] font-bold ">
                Payment Methods
              </h1>{" "}
              <br /> <br />
