  ...
  return (
    <>
      ...
      <div className="flex justify-center flex-col  mb-[120px]  md:mx-[120px] ">
        ...
        <div className="flex justify-center flex-col border-[15px] bg-white border-[#75618a] p-10 ">
          <div className="flex items-center gap-2">
            <MdLocalShipping className="text-[#734F96] text-[1.5rem] font-bold " />
          ...
          <div className="flex flex-col justify-center">
            ...
            <br />
            <div className="flex items-center gap-2">
              <FaExchangeAlt className="text-[#734F96] text-[1.5rem] font-bold " />
              <h1 className="text-[#734F96] text-[1.5rem] font-bold ">
